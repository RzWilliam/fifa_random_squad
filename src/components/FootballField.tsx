  ...
  return (
    <div className="w-full max-w-4xl mx-auto bg-gradient-to-b from-green-600 to-green-700 rounded-lg shadow-2xl overflow-hidden">
      ...
      <div className="bg-gray-900 text-white p-4 text-center">
        ...
        <p className="text-green-400 text-sm">FIFA Ultimate Team</p>
      </div>
      ...
      <div className="relative w-full aspect-[3/4] bg-gradient-to-b from-green-500 to-green-600 overflow-hidden">
        ...
        <svg className="absolute inset-0 w-full h-full" viewBox="0 0 300 400">
          ...
          {/* Cercle central */}
          <circle cx="150" cy="200" r="30" fill="none" stroke="white" strokeWidth="2" />
          ...
          <rect x="110" y="10" width="80" height="20" fill="none" stroke="white" strokeWidth="2" />
          <circle cx="150" cy="72" r="8" fill="none" stroke="white" strokeWidth="2" />
          
          {/* Surface de réparation basse */}
          <rect x="70" y="340" width="160" height="50" fill="none" stroke="white" strokeWidth="2" />
          <rect x="110" y="370" width="80" height="20" fill="none" stroke="white" strokeWidth="2" />
          <circle cx="150" cy="328" r="8" fill="none" stroke="white" strokeWidth="2" />
          ...
          <path d="M 10 390 Q 20 390 20 380" fill="none" stroke="white" strokeWidth="2" />
          <path d="M 290 390 Q 280 390 280 380" fill="none" stroke="white" strokeWidth="2" />
        </svg>
      ...
      <div className="bg-gray-800 p-4">
        <h3 className="text-white text-lg font-semibold mb-3 text-center">Remplaçants</h3>
